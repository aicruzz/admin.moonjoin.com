        ...
        <div class="navbar-vertical-container">
            ...
            <div class="navbar-vertical-content bg--005555" id="navbar-vertical-content">
                ...
                <ul class="navbar-nav navbar-nav-lg nav-tabs">
                    ...
                    <!-- debit_delivery_man -->
                    @if (\App\CentralLogics\Helpers::module_permission_check('debit_delivery_man'))
                        <li
                            class="navbar-vertical-aside-has-menu {{ Request::is('admin/transactions/debit-delivery-man*') ? 'active' : '' }}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link"
                                href="{{ route('admin.transactions.debit-delivery-man.index') }}"
                                title="{{ translate('messages.debit_delivery_man') }}">
                                <i class="tio-remove-from-trash nav-icon"></i>
                                <span
                                    class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{ translate('Debit Delivery Men') }}</span>
                            </a>
                        </li>
                    @endif
                    <!-- End debit_delivery_man -->
