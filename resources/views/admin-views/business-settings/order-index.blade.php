                            ...
                            <div class="row g-3 align-items-end">
                                    ...
                                    <div class="form-group mb-0">
                                        ...
                                        <label
                                            ...
                                            <input type="checkbox" data-id="prescription_order_status"
                                                ...
                                                class="status toggle-switch-input dynamic-checkbox-toggle" value="1"
                                                name="prescription_order_status" id="prescription_order_status" {{ $prescription_order_status == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" data-id="home_delivery" data-type="toggle"
                                                ...
                                                name="home_delivery_status" id="home_delivery" value="1" {{ $home_delivery_status == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                    ...
                                    <div class="form-group mb-0">
                                        <label
                                            ...
                                            <input type="checkbox" data-id="schedule_order" data-type="toggle"
                                                ...
                                                class="status toggle-switch-input dynamic-checkbox-toggle" value="1"
                                                name="schedule_order" id="schedule_order" {{ $schedule_order == 1 ? 'checked' : '' }}>
                                            <span class="toggle-switch-label text">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                        </label>
                                ...
                                <div class="mb-3 access_product_approval">
                                    ...
                                    <label class="mb-2 input-label text-capitalize d-flex alig-items-center" for="">
                                        <img src="{{ asset('/public/assets/admin/img/icon-park_ad-product.png') }}"
                                            alt=""
                                        ...
                                        @foreach (config('module.module_type') as $key => $value)
                                            @if ($value != 'parcel' && $value != 'rental')
                                                <div class="form-check form-check-inline mx-4  ">
                                                    <input class="mx-2 form-check-input" type="checkbox" {{  data_get($extra_packaging_data, $value, null) == 1 ? 'checked' : '' }}
                                                        id="inlineCheckbox{{$key}}" value="1" name="{{ $value }}">
                                                    <label class=" form-check-label"
                                                        for="inlineCheckbox{{$key}}">{{ translate($value) }}</label>
                                                </div>
                                            @endif
                                        @endforeach
                                ...
                                <div class="border-bottom d-flex justify-content-between p-3">
                                    ...
                                    <label class="form-label d-flex justify-content-between text-capitalize mb-1"
                                        ...
                                        <span class="toggle-switch toggle-switch-sm pr-sm-3">
                                            <input type="checkbox" data-id="admin_free_delivery_status"
                                                data-type="toggle"
                                                ...
                                                value="1" {{ $admin_free_delivery_status?->value ? 'checked' : '' }}>
                                    ...
                                    <div class="row g-3 align-items-end">
                                        ...
                                        <div id="show_text_for_all_store_free_delivery"
                                            ...
                                            <div class="alert fs-13 alert-primary-light text-dark mb-0  mt-md-0 add_text_mute text-muted"
                                                role="alert">
                                                <img src="{{ asset('/public/assets/admin/img/lnfo_light.png') }}"
                                                    alt="">
                                                    ...
                                                    <form
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <select name="user_type" class="form-control h--45px"
                                                                ...
                                                                <option {{ $reason->user_type == 'admin' ? 'selected' : '' }} value="admin">{{ translate('messages.admin') }}
                                                                </option>
                                                                <option {{ $reason->user_type == 'store' ? 'selected' : '' }} value="store">{{ translate('messages.store') }}
                                                                </option>
    ...
    <div class="mt-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                {{-- Add Form --}}
                <form action="{{ route('admin.business-settings.debit-deliveryman-reasons.store') }}" method="post">
                    @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 dm_lang_form dm-default-form">
                            ...
                            <input type="text" class="form-control h--45px" name="reason[]" id="dm_order_cancellation"
                            ...
                            <div class="table-responsive datatable-custom">
                                <table class="table table-borderless table-thead-bordered table-align-middle"
                                    ...
                                    <tbody>
                                        ...
                                        {{-- Edit Modal --}}
                                        <div class="modal fade" id="dm_update_reason_{{ $dm_reason->id }}" tabindex="-1"
                                                            ...
                                                            <ul class="nav nav-tabs nav--tabs mb-3 border-0">
                                                                ...
                                                                @if ($dm_edit_lang)
                                                                    @foreach (json_decode($dm_edit_lang) as $edit_lang)
                                                                        <li class="nav-item">
                                                                            <a class="nav-link dm-update-lang_link" href="#"
...
@push('script_2')
    ...
    <script>
        "use strict";
        /* ---- Delivery Man Cancellation – Add-form language tabs ---- */
        $(document).on('click', '.dm_lang_link', function (e) {
            e.preventDefault();
            var id = $(this).attr('id').replace('-link', '');
            $('.dm_lang_link').removeClass('active');
            $(this).addClass('active');
            $('.dm_lang_form').addClass('d-none');
            $('#' + id + '-form').removeClass('d-none');
        });

        /* ---- Delivery Man Cancellation – Edit-modal language tabs ---- */
        $(document).on('click', '.dm-update-lang_link', function (e) {
            e.preventDefault();
            var rawId = $(this).attr('id');                    // e.g. "dm-edit-fr-link" or "dm-edit-default-link"
            var reasonId = $(this).data('reason-id') || '';
            var tabId = rawId.replace('-link', '');            // e.g. "dm-edit-fr" or "dm-edit-default"

            // Deactivate all tabs inside this modal
            var $modal = $(this).closest('.modal');
            $modal.find('.dm-update-lang_link').removeClass('active');
            $(this).addClass('active');

            // Hide all lang forms in this modal
            $modal.find('.dm-update-lang_form').addClass('d-none');

            if (tabId === 'dm-edit-default') {
                $modal.find('[id^="dm-edit-default-form_"]').removeClass('d-none');
            } else {
                var langCode = tabId.replace('dm-edit-', '');    // e.g. "fr"
                $modal.find('#dm-edit-' + langCode + '-langform_' + reasonId).removeClass('d-none');
            }
        });
    </script>
@endpush