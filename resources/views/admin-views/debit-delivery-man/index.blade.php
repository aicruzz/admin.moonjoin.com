                    ...
                    <div class="col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <select class="form-control" name="reason" id="reason">
                                ...
                                <option value="order_penalty">{{ translate('Order Penalty') }}</option>
                                <option value="late_delivery_penalty">{{ translate('Late Delivery Penalty') }}</option>
...
{{-- Confirmation Modal --}}
{{-- ============================================================ --}}
<div class="modal fade" id="debitConfirmModal" tabindex="-1" role="dialog" aria-labelledby="debitConfirmModalLabel" aria-hidden="true">
